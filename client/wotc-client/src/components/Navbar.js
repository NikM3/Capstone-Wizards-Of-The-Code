        ...
        <>
            <nav className="navbar navbar-light bg-purple text-white justify-content-between">
                <div className="d-flex px-5 my-1 align-items-center">
                    ...
                    <ul className="nav">
                        <li className="nav-item ">
                            <Link to={"/home"} className="mx-4 nav-link text-white link-size">
                                Home
                            </Link>
                        </li>
                        <li className="nav-item ">
                            <Link
                                to={"/collection"}
                                className="nav-link text-white link-size"
                            >
                                My Collection
                            </Link>
                        </li>
                        <li className="nav-item ">
                            {user?.roles?.[0]?.authority === "ADMIN" && (
                                <Link to={"/admin"} className="nav-link text-white link-size">
                                    Admin
                                </Link>
                            )}
                        </li>
                ...
                <div className="d-flex align-items-center">
                    ...
                    <p
                        className="btn btn-lg bg-blue text-white mt-2 mx-3"
